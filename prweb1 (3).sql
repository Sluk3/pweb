...
--
-- Host: 127.0.0.1
-- Creato il: Gen 02, 2025 alle 12:27
...
(1, 'Sluke', '2024-11-18 19:20:12', 1),
(2, 'Sluke', '2025-01-01 20:23:17', 1),
(3, 'Sluke', '2025-01-01 20:37:48', 1),
(4, 'Sluke', '2025-01-01 20:42:25', 1),
(5, 'Sluke', '2025-01-01 20:44:46', 1),
(6, 'Sluke', '2025-01-01 20:46:10', 1),
(7, 'Sluke', '2025-01-01 20:54:19', 1);
...
INSERT INTO `product` (`id`, `title`, `type_id`, `descr`, `bpm`, `tonality`, `genre`, `num_sample`, `num_tracks`, `audiopath`, `productpath`) VALUES
('A2', 'Neve', 1, 'A composition usually sold to singer or rapper to sing onto', 140, 'E', 'Emo Trap', 0, 0, NULL, ''),
('A7', 'Dark Road', 1, '-', 132, 'Cm', 'Trap', 0, 0, NULL, ''),
('A8', 'Waves', 1, 'chitarrina ns', 145, 'Gm', 'Trap', 0, 0, '../AUDIO/air-horn_1.mp3', '../PRODUCTS/BlockDAGv1.4.apk'),
('A9', 'Bloodclat', 1, '-', 130, 'G#m', 'DNB', 0, 0, '../AUDIO/PUT CHA BACK IN IT w_ HEDO & SOULELY - 12A - 130.mp3', '../PRODUCTS/Cajmere feat Dajae - Brighter Days (Géo Baile Remix).mp3'),
('B1', 'UKG master race', 2, '', 0, 'nul', 'UKG', 500, 0, NULL, ''),
